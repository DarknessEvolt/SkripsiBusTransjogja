 ...
 * be configured.
 */
public class MessageEventGeneratorPrima implements EventQueue {
	 ...
	 */
	public MessageEventGeneratorPrima(Settings s){
...
//		}
	 ...
	 */
	protected int drawToAddress(int toHostRange[]) {
		if (toHostRange[1] == toHostRange[0]) {
			return toHostRange[0];
		}
		return toHostRange[0] + rng.nextInt(toHostRange[1] - toHostRange[0]);
	}
	...
	public ExternalEvent nextEvent() {
		...
		to = drawToAddress(this.toHostRange);
