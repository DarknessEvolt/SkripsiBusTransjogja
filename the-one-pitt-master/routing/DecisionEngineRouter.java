...
public class DecisionEngineRouter extends ActiveRouter {
    ...
    protected RoutingDecisionEngineWithCalculation decider;
    ...
    public DecisionEngineRouter(Settings s) {
        ...
        decider = (RoutingDecisionEngineWithCalculation) routeSettings.createIntializedObject(
    ...
    public RoutingDecisionEngineWithCalculation getDecisionEngine() {
        return this.decider;
    }
    ...
    //jalur untuk pesan L (pelanggaran)(d1)
